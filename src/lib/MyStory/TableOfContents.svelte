...
<aside
	class="mb-16 mt-2 flex items-center justify-center xxs:gap-x-2 xs:gap-x-4 sm:gap-x-9 lg:gap-x-16"
>
	{#each $highlighted as h, ind}
		<button
			...
			class="font-poppins font-bold xxs:text-sm xs:text-base sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl 3xl:text-7xl {$highlighted[
				...
				? 'text-carmine'
				: 'text-portfolio'} transition-colors duration-300 ease-in-out hover:text-carmine"
		>
