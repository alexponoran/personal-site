...
<header
	class="flex items-center justify-between {color} pt-8 font-roboto xxs:px-2 xs:px-4 sm:px-12 md:px-24"
>
	...
	>
		...
		<NavbarItem href="/my-story" text="my story" />
